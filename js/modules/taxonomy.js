...
export const TAXONOMY = {
  ...
  pear_liqueur: {
    ...
    brands: [
      ...
      'Rothman and Winter Pear',
      'Belle de Brillet',
      'Giffard Poire William',
      'Briottet Crème de Poire',
    ],
  },
  plum_liqueur: {
    id: 'plum_liqueur',
  ...
  honey_ginger_syrup: {
    ...
    dark: '#9a6f1c',
    defaultAbv: 0,
    aliases: ['honey ginger syrup', 'ginger honey syrup', 'honey and ginger syrup', 'ginger honey'],
  },
  agave_syrup: {
    id: 'agave_syrup',
  ...
  lingonberry_syrup: {
    id: 'lingonberry_syrup',
    name: 'Lingonberry Syrup',
    family: 'flavored_syrup',
    parent: 'sweeteners',
    color: '#9e1b32',
    light: '#bf2c47',
    dark: '#6e0d1f',
    defaultAbv: 0,
    aliases: ['lingonberry syrup', 'lingonberry simple syrup', 'lingonberry cordials', 'lingonberry cordial'],
    brands: [
      'Felix',
      'Darbo',
      'IKEA',
  ...
  pear_syrup: {
    ...
    dark: '#c9be9f',
    defaultAbv: 0,
    aliases: ['pear syrup', 'spiced pear syrup', 'pear simple syrup'],
    brands: [
      'Monin',
      'Torani',
      '1883 Maison Routin',
  ...
  water: {
    ...
    dark: '#e2e8f0',
    defaultAbv: 0,
    aliases: ['water', 'boiling water', 'hot water', 'chilled water', 'tap water', 'cold water', 'warm water'],
  },
  celery_salt: {
    id: 'celery_salt',
  ...
  ground_cinnamon: {
    ...
    dark: '#6e3416',
    defaultAbv: 0,
    aliases: ['cinnamon', 'ground cinnamon', 'cinnamon powder', 'grated cinnamon'],
  },
};
