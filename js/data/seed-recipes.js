...
export const SEED_RECIPES = [
  ...
  // 91. King Kong
  {
    ...
    method: "Stirred",
    garnish: "Lemon peel",
    description: "A deliciously funky, tropical spin on the Old Fashioned from Sam Ross. Bourbon meets the high-ester funk of Jamaican rum and the rich sweetness of banana liqueur — stirred, not shaken, over a large cube.",
  ...
  // 97. Whiskey Lullaby
  {
    ...
    method: "Stirred",
    garnish: "Lemon peel",
    description: "A soul-soothing nightcap from Janessa Flowers at Watershed Distillery. Bourbon as the base, Averna for body and richness, Bénédictine for mouthfeel, and Nocino for nuttiness. Stirred and strained over a large cube — the dilution is intentional.",
  ...
  // 98. Hot Buttered Rum
  {
    ...
    description: "A colonial American restorative dating to the 17th century. Aged rum meets a warm blend of butter, brown sugar, cinnamon, nutmeg, orange zest, and vanilla — a cold-weather drink built for sitting by a fire.",
  ...
  // 99. Cabaret
  {
    ...
    method: "Stirred",
    garnish: "Lemon twist",
    description: "A variation on the original Cabaret from Harry Craddock's Savoy Cocktail Book (1930), adapted with Lillet Blanc in place of Caperitif — the aromatized wine called for in the original, now nearly unobtainable.",
  ...
  // 100. Razzle Dazzle
  {
    ...
    notes: "",
    tags: ["modern-craft", "vodka-forward", "fruity", "sparkling", "citrus-forward", "celebratory"],
    specs: [
      { amount: 1.5, unit: "oz", name: "Vodka" },
